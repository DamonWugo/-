...
const articlePublish = {
  ...
  mutations: {
    ADDARTICLE(state, value) {
      state.articlePublishArr.unshift(value);
    },
  },
  actions: {
    addArticle(context, value) {
      context.commit("ADDARTICLE", value);
    },
  },
  getters: {},
};
...
const articleTalk = {
  ...
  mutations: {
    ADDTALK(state, value) {
      state.articleTalkArr.unshift(value);
    },
  },
  actions: {
    addTalk(context, value) {
      context.commit("ADDTALK", value);
    },
  },
  getters: {},
};
